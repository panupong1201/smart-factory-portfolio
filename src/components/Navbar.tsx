      ...
      <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex justify-between items-center relative">
        ...
        <a href="#" className="flex items-center gap-3 group">
          <div className="relative flex items-center justify-center w-10 h-10 bg-black border border-gray-800 rounded overflow-hidden group-hover:border-purple-500 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0)] group-hover:shadow-[0_0_20px_rgba(168,85,247,0.5)]">
             <span className="font-bold text-white text-xl z-10 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-tr group-hover:from-blue-400 group-hover:to-purple-500 transition-all">P</span>
          </div>
          <div className="flex flex-col leading-none">
            <span className="font-bold text-white tracking-wider group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-500 transition-all">
              PANUPONG
            </span>
        ...
        <div className="hidden md:flex gap-1 items-center bg-white/5 px-2 py-1 rounded-full border border-white/10 backdrop-blur-md">
          ...
          {['about', 'skills', 'timeline', 'projects', 'certificates', 'contact'].map((key) => (
            ...
            >
              <span className="absolute top-0 left-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-blue-500 to-transparent -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_10px_#3b82f6]" />
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex bg-black/50 rounded-lg p-1 border border-white/10">
            <motion.div 
              layout
              className={`absolute top-1 bottom-1 w-[34px] bg-gradient-to-br from-blue-600 to-purple-600 rounded shadow-[0_0_10px_rgba(124,58,237,0.4)]`}
              initial={false}
          ...
          <a
            ...
            className="hidden lg:flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-lg text-sm font-bold transition-all shadow-[0_0_15px_rgba(99,102,241,0.4)] hover:shadow-[0_0_25px_rgba(168,85,247,0.6)] group"
          >
            <span>{t("navbar.hire")}</span>
