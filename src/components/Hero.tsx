    ...
    >
      ...
      <div className="max-w-7xl w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8">
          ...
          >
            {t("hero.greeting")} {t("hero.transformingLine")}
          </motion.p>
          ...
          >
            <a
              href="#projects"
              className="group relative px-8 py-4 bg-blue-600 text-white rounded-full font-bold overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(37,99,235,0.5)]"
            >
              <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:animate-[shimmer_1s_infinite]" />
        ...
        >
          ...
          <div className="relative w-[380px] h-[500px] bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl group">
            ...
            <div className="absolute inset-0 z-0">
              ...
              <div className="absolute inset-0 bg-linear-to-t from-blue-500 via-transparent to-transparent opacity-0 group-hover:opacity-20 mix-blend-overlay transition-opacity duration-300" />
            </div>
