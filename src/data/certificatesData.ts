...
export const certificatesData = [
  ...
  },
  {
    ...
    year: "2026",
    category: "Award",
    description: "Special recognition from the Managing Director for outstanding performance.",
    details: [
  ...
  },
  {
    ...
    description: "Training on NotebookLM: AI Tools for Education & Knowledge Management.",
    details: [
  ...
  // =========================================================
  {
    ...
    year: "Nov 2025",
    category: "Award",
    description: "Perfect score (100%) in Electrostatic Discharge (ESD) Control Audit.",
    details: [
  ...
  },
  {
    ...
    year: "2025",
    category: "Award",
    description: "Awarded to the most outstanding new employee for excellent performance.",
    details: [
  ...
  },
  {
    ...
    year: "2025",
    category: "Award",
    description: "Award for excellence in internal communication and reporting.",
    details: [
  ...
  // =========================================================
  {
    ...
    year: "Feb 2024",
    category: "Certificate",
    description: "Training course on Human Machine Interface (HMI) Programming.",
    details: [
      "Duration: 2 Days.",
  ...
  },
  {
    ...
    year: "2024",
    category: "Certificate",
    description: "Training course on Basic PLC Programming (Mitsubishi FX Series).",
    details: [
      "Duration: 2 Days.",
  ...
  // =========================================================
  {
    ...
    year: "2023",
    category: "Certificate",
    description: "National Skill Standard Certification: Building Electrician Level 1.",
    details: [
      "Duration: 2 Days.",
